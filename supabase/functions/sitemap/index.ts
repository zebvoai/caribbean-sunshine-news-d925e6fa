...
serve(async () => {
  try {
    ...
    const staticEvergreen = [
      ...
      { path: "/roseau-news", changefreq: "daily", priority: "0.8" },
      { path: "/portsmouth-news", changefreq: "daily", priority: "0.8" },
      { path: "/hurricane-season-dominica", changefreq: "weekly", priority: "0.8" },
      { path: "/dominica-elections", changefreq: "weekly", priority: "0.8" },
