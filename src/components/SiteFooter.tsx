import { Facebook, Instagram, Twitter, ArrowUp, Heart } from "lucide-react";
...
const SiteFooter = () => {
  ...
  const socials = [
    ...
    { Icon: Twitter, href: "https://x.com/Dominicanewsdm", label: "X (Twitter)" },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 pt-20 pb-14">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-1">
            <img src={logoImg} alt="Dominica News DM" className="h-10 w-auto mb-5 brightness-0 invert opacity-80" />
