  ...
  return (
    <div className="p-4 sm:p-6 max-w-5xl mx-auto">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-8">
        <div>
          <h1 className="text-2xl sm:text-3xl font-heading font-bold text-foreground">Categories</h1>
      ...
      {isLoading ? (
        ...
        <div className="space-y-3">
          {categories.map((cat) => (
            <div
              key={cat.id}
              className="relative flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-5 px-4 sm:px-6 py-4 sm:py-5 rounded-xl border border-border bg-card hover:shadow-md transition-shadow"
            >
              {/* Icon */}
              <div className="hidden sm:block flex-shrink-0 text-muted-foreground">
              ...
              <div className="flex items-center gap-1.5 sm:absolute sm:right-5 sm:top-1/2 sm:-translate-y-1/2 sm:opacity-0 sm:group-hover:opacity-100 self-end sm:self-auto">
                <Button
                  size="icon"
